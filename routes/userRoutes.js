...
router.post("/Register", function(req, res, next) { //this line activates the function when a user sends a post request to '/Register'.
	...
	var user = new User(); //this line declares a variable 'user' equal to the object constructor 'new User()'; N ---> 'User' is connected to the mongoose model.
	...
	user.save(function(err, user) { //this line says to save the 'user' object to MONGODB.
		...
		}); //this line says to parsify the response with json and send the new JWT to THE CLIENT.
	});

...
//this line imports jsonwebtoken
var UserSchema = new mongoose.Schema({ //this line declares a variable 'UserSchema' equal to the object constructor 'mongoose.Schema'.
	username: {
		...
		lowercase: true,
		unique: true
	}, //this line is a property 'username' which key value is formatted according to the mongodb Schema.
	email: {
		type: String,
		unique: true,
		lowercase: true
	}, //this line is a property 'email' which key value is formatted according to the mongodb Schema.
...
mongoose.model('UserModel', UserSchema); //this line declares the mongoose model's name to be "User" and to use the 'UserSchema' as the schematics for the model.
